...
function SidebarMenuButton({
  ...
  const button = <Comp suppressHydrationWarning data-slot="sidebar-menu-button" data-sidebar="menu-button" data-size={size} data-active={isActive} className={cn(sidebarMenuButtonVariants({ variant, size }), className)} {...props} />;
...
function SidebarMenuSkeleton({
  ...
  const [width] = React.useState(() => {
    return `${Math.floor(Math.random() * 40) + 50}px`;
  });
